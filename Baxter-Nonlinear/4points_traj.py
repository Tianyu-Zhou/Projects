...
while not rospy.is_shutdown():
	...
	if n == 0:
		...
		#~ print(abs(qr-pos1)<=0.3)
		#~ print((abs(qr-pos1)<=0.3).all())
		if ((abs(qr-pos1)<=0.3).all()) or abs(t-t_d)<=0.01:
			n = 1
	...
	if n == 1:
		...
		#~ print(abs(qr-pos2)<=0.3)
		#~ print((abs(qr-pos2)<=0.3).all())
		if ((abs(qr-pos2)<=0.3).all()) or abs(t-t_d)<=0.01:
			n = 2
	...
	if n == 2:
		...
		#~ print(abs(qr-pos3)<=0.3)
		#~ print((abs(qr-pos3)<=0.3).all())
		if ((abs(qr-pos3)<=0.3).all()) or abs(t-t_d)<=0.01:
			n = 3	
	...
	if n == 3:
		...
		#~ print(abs(qr-pos4)<=0.3)
		#~ print((abs(qr-pos4)<=0.3).all())
		if ((abs(qr-pos4)<=0.3).all()) or abs(t-t_d)<=0.01:
			n = 4			
	...
	if n == 4:
		...
		if ((abs(thr-qr_d)<=0.1).all) or t >10:
			break
