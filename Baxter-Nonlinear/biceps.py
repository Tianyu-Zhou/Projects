...
(trajl_0, trajl_dot_0, trajl_2dot_0) = trajectory.get_1trajectory(thl_init[0], thl_1[0], t_d)
(trajl_1, trajl_dot_1, trajl_2dot_1) = trajectory.get_1trajectory(thl_init[1], thl_1[1], t_d)
(trajl_2, trajl_dot_2, trajl_2dot_2) = trajectory.get_1trajectory(thl_init[2], thl_1[2], t_d)
(trajl_3, trajl_dot_3, trajl_2dot_3) = trajectory.get_1trajectory(thl_init[3], thl_1[3], t_d)
(trajl_4, trajl_dot_4, trajl_2dot_4) = trajectory.get_1trajectory(thl_init[4], thl_1[4], t_d)
(trajl_5, trajl_dot_5, trajl_2dot_5) = trajectory.get_1trajectory(thl_init[5], thl_1[5], t_d)
(trajl_6, trajl_dot_6, trajl_2dot_6) = trajectory.get_1trajectory(thl_init[6], thl_1[6], t_d)

(trajr_0, trajr_dot_0, trajr_2dot_0) = trajectory.get_1trajectory(thr_init[0], thr_1[0], t_d)
(trajr_1, trajr_dot_1, trajr_2dot_1) = trajectory.get_1trajectory(thr_init[1], thr_1[1], t_d)
(trajr_2, trajr_dot_2, trajr_2dot_2) = trajectory.get_1trajectory(thr_init[2], thr_1[2], t_d)
(trajr_3, trajr_dot_3, trajr_2dot_3) = trajectory.get_1trajectory(thr_init[3], thr_1[3], t_d)
(trajr_4, trajr_dot_4, trajr_2dot_4) = trajectory.get_1trajectory(thr_init[4], thr_1[4], t_d)
(trajr_5, trajr_dot_5, trajr_2dot_5) = trajectory.get_1trajectory(thr_init[5], thr_1[5], t_d)
(trajr_6, trajr_dot_6, trajr_2dot_6) = trajectory.get_1trajectory(thr_init[6], thr_1[6], t_d)



# Gain
#LEFT
k11l = 1; k12l = 5; k13l = 1; k14l = 3; k15l = 1; k16l = 0.5; k17l = 1;
k1l_array = np.array([k11l, k12l, k13l, k14l, k15l, k16l, k17l]);
k1l = np.diag(k1l_array);

k21l = 0.3; k22l = 3; k23l = 0.3; k24l = 1.5; k25l = 0.3; k26l = 0.2; k27l = 0.3;
k2l_array = np.array([k21l, k22l, k23l, k24l, k25l, k26l, k27l]);
k2l = np.diag(k2l_array);

Be1l = 35;  Be2l = 4; Be3l = 10;  Be4l = 6; Be5l = 8;  Be6l = 6; Be7l = 10;
Bel_array = np.array([Be1l, Be2l, Be3l, Be4l, Be5l, Be6l, Be7l]);
Bel = np.diag(Bel_array);

#RIGHT
k11r = 1; k12r = 5; k13r = 1; k14r = 4; k15r = 1.5; k16r = 1; k17r = 0.5;
k1r_array = np.array([k11r, k12r, k13r, k14r, k15r, k16r, k17r]);
k1r = np.diag(k1r_array);

k21r = 0.3; k22r = 3; k23r = 0.3; k24r = 2; k25r = 0.3; k26r = 0.8; k27r = 0.2;
k2r_array = np.array([k21r, k22r, k23r, k24r, k25r, k26r, k27r]);
k2r = np.diag(k2r_array);

Be1r = 35;  Be2r = 4; Be3r = 10;  Be4r = 3; Be5r = 6;  Be6r = 2.5; Be7r = 10;
...
while not rospy.is_shutdown():
	...
	if n == 0:
		...
		if abs(t-t_d)<=0.01:
			n = 1
	if n == 1:
		t = t_d-(cur_time - time_init - n*t_d)
		print(t)
		qr_d = np.array([trajr1_0(t), trajr1_1(t), trajr1_2(t), trajr1_3(t), trajr1_4(t), trajr1_5(t), trajr1_6(t)])
		qdotr_d = np.array([trajr1_dot_0(t), trajr1_dot_1(t), trajr1_dot_2(t), trajr1_dot_3(t), trajr1_dot_4(t), trajr1_dot_5(t), trajr1_dot_6(t)])
		qddotr_d = np.array([trajr1_2dot_0(t), trajr1_2dot_1(t), trajr1_2dot_2(t), trajr1_2dot_3(t), trajr1_2dot_4(t), trajr1_2dot_5(t), trajr1_2dot_6(t)])	
