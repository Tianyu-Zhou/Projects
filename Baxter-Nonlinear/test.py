...
#~ #LEFT
#~ k11l = 1; k12l = 1; k13l = 1; k14l = 1; k15l = 1; k16l = 1; k17l = 1;
#~ k1l_array = np.array([k11l, k12l, k13l, k14l, k15l, k16l, k17l]);
#~ k1l = np.diag(k1l_array);
#~ 
...
#~ 
#~ #RIGHT
#~ k11r = 1; k12r = 2.2; k13r = 1; k14r = 1.5; k15r = 1.5; k16r = 1; k17r = 1;
#~ k1r_array = 2*np.array([k11r, k12r, k13r, k14r, k15r, k16r, k17r]);
#~ k1r = np.diag(k1r_array);
#~ 
#~ k21r = 1; k22r = 1; k23r = 1.2; k24r = 1.2; k25r = 0.7; k26r = 1; k27r = 1.2;
#~ k2r_array = 0.5*np.array([k21r, k22r, k23r, k24r, k25r, k26r, k27r]);
#~ k2r = np.diag(k2r_array);
#~ 
#~ Be1r = 14;  Be2r = 2; Be3r = 4;  Be4r = 5; Be5r = 4; Be6r = 2; Be7r = 2;
#~ Ber_array = np.array([Be1r, Be2r, Be3r, Be4r, Be5r, Be6r, Be7r]);
#~ Ber = np.diag(Ber_array);
#~ 
...
while not rospy.is_shutdown():
	...
	tau_app = np.array(np.vectorize(bax.rarm.joint_efforts().get)(rarm_mapping))
	print(tau_app)
	...
	#~ qdotr_fil = butter_lowpass_filter(qdotr, 10, 50, order=5)
	#~ qdotr = butter_lowpass_filter(qdotr, 20, 50, order=5)
	
	#~ psir = bax_controller.get_torque(qr, qdotr_fil, qddotr_d, qr_d, qdotr_d, k1r, k2r, Ber)
